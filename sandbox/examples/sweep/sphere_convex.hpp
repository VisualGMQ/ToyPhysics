...
class SphereConvexSweepExample : public IExample {
public:
...
inline void SphereConvexSweepExample::OnUpdate(float delta_time) {}

inline void SphereConvexSweepExample::OnRender3D(float delta_time) {
...
inline void SphereConvexSweepExample::OnRender2D(float delta_time) {
