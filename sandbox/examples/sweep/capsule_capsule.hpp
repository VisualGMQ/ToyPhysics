...
inline void CapsuleCapsuleSweepExample::OnUpdate(float delta_time) {}

inline void CapsuleCapsuleSweepExample::OnRender3D(float delta_time) {
    ...
    toy_physics::CapsuleSupportFunction s1(ToVec3(m_c1), ToVec3(axis1), m_hh1,
                                           m_rv1);
    toy_physics::CapsuleSupportFunction s2(ToVec3(m_c2), ToVec3(axis2), m_hh2,
                                           m_rv2);
...
inline void CapsuleCapsuleSweepExample::OnRender2D(float delta_time) {
