...
class CapsuleConvexSweepExample : public IExample {
public:
...
inline void CapsuleConvexSweepExample::OnUpdate(float delta_time) {}

inline void CapsuleConvexSweepExample::OnRender3D(float delta_time) {
...
inline void CapsuleConvexSweepExample::OnRender2D(float delta_time) {
