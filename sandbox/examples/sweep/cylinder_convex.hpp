...
class CylinderConvexSweepExample : public IExample {
public:
...
inline void CylinderConvexSweepExample::OnUpdate(float delta_time) {}

inline void CylinderConvexSweepExample::OnRender3D(float delta_time) {
...
inline void CylinderConvexSweepExample::OnRender2D(float delta_time) {
