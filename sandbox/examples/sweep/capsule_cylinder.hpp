...
class CapsuleCylinderSweepExample : public IExample {
public:
...
inline void CapsuleCylinderSweepExample::OnUpdate(float delta_time) {}

inline void CapsuleCylinderSweepExample::OnRender3D(float delta_time) {
...
inline void CapsuleCylinderSweepExample::OnRender2D(float delta_time) {
