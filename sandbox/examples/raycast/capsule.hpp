...
inline void CapsuleRaycastExample::OnUpdate(float delta_time) {}

inline void CapsuleRaycastExample::OnRender3D(float delta_time) {
    ::Vector3 origin = m_ray.GetOrigin(m_center);
    ::Vector3 dir = m_ray.GetDirection();

    m_ctx.DrawCapsule(m_center, m_rotation, m_half_height * 2.f, m_radius, BLUE);
    ...
    m_hit_count = toy_physics::RaycastCapsule(
...
inline void CapsuleRaycastExample::OnRender2D(float delta_time) {
