...
bool SweepSphereSphere(Vector3 s1, real r1, Vector3 s2, real r2,
                           Vector3 dir, real len, SweepHit* out_hit,
                           QueryFlags = QueryFlag::Default);

bool SweepSphereCapsule(Vector3 s1, real r1, Vector3 center, Vector3 axis,
                            real half_height, real radius, Vector3 dir,
